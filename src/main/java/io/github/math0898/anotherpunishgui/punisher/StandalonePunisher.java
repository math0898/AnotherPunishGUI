...
public class StandalonePunisher implements Punisher {
    ...
    public void punish (Punishment punishment, CommandSender staff, Player player) {
        ...
        if (punishment.type().equalsIgnoreCase("ban")) Bukkit.getServer().dispatchCommand(staff, "ban " + player.getName() + " " + punishment.durations().get(durIndex) + "h You have been banned for " + punishment.displayName() + ChatColor.RESET + ". (" + punishment.displayDuration(durIndex) + ")");
        ...
        else if (punishment.type().equalsIgnoreCase("mute")) Bukkit.getServer().dispatchCommand(staff, "mute " + player.getName() + " " + punishment.durations().get(durIndex) + "h You have been muted for " + punishment.displayName() + ChatColor.RESET + ". (" + punishment.displayDuration(durIndex) + ")");
